            ...
            <div className="space-y-10 md:space-y-12">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
                <div className="space-y-6">
                  ...
                  <div className="flex items-start gap-4">
                    <Mail className="text-brand-accent shrink-0" size={24} />
                    <div>
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    <Building2 className="text-brand-accent shrink-0" size={24} />
                    <div>
                  ...
                  <div className="flex items-start gap-4">
                    <CreditCard className="text-brand-accent shrink-0" size={24} />
                    <div>
              ...
              <div className="pt-8 md:pt-12 border-t border-white/10">
                <div className="flex items-start gap-4">
                  <Landmark className="text-brand-accent shrink-0" size={24} />
                  <div>
