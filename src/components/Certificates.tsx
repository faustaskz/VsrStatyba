      ...
      <div className="max-w-7xl mx-auto text-center">
        ...
        >
          ...
          <p className="text-sm md:text-[16px] leading-relaxed text-brand-dark/70">
            UAB „VG Statyba" turi visus reikalingus leidimus ir sertifikatus statybos darbams vykdyti Lietuvos Respublikoje. Mūsų kvalifikacija patvirtinta atitinkamomis institucijomis.
          </p>
        </motion.div>
        ...
        <div className="flex justify-center">
          <motion.div
            ...
            viewport={{ once: true }}
            whileHover={{ y: -10 }}
            className="bg-white p-8 md:p-12 shadow-2xl border-t-8 border-brand-red max-w-md w-full text-left relative overflow-hidden group"
          >
            <div className="absolute top-0 right-0 p-4 opacity-5 group-hover:opacity-10 transition-opacity">
              <ShieldCheck size={80} className="md:size-[120px]" />
            </div>
            
            <ShieldCheck className="text-brand-red mb-6 md:mb-8" size={40} />
            ...
            <div className="flex items-center gap-2 text-[10px] md:text-sm font-bold uppercase tracking-widest text-brand-red">
